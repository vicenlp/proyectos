    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Usuario activo</span>
                </a>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version</b> 1.0.0.2018816
        </div>
        <strong>Copyright &copy; <a href="https://www.facebook.com/vicen.gimenez.9">cristian Gimenez</a>.</strong>
      </footer>
